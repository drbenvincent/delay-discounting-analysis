classdef ModelHierarchicalHyperboloidB < HyperboloidB
	%ModelHierarchicalHyperboloidB A model to estimate the log discount rate, according to the 1-parameter hyperbolic discount function.
    %  All parameters are estimated hierarchically.

	methods (Access = public, Hidden = true)

		function [obj] = ModelHierarchicalHyperboloidB(data, varargin)
			obj = obj@HyperboloidB(data, varargin{:});
            obj.modelFilename = 'hierarchicalHyperboloidB';
