classdef ModelMixedHyperboloidB < HyperboloidB
	%ModelMixedHyperboloidB A model to estimate the log discount rate, according to the 2-parameter hyperboloid discount function.
	%  SOME parameters are estimated hierarchically.

	methods (Access = public, Hidden = true)
		function obj = ModelMixedHyperboloidB(data, varargin)
			obj = obj@HyperboloidB(data, varargin{:});
			obj.modelFilename = 'mixedHyperboloidB';
