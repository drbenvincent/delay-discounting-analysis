classdef (Abstract) Hyperbolic1MagEffectMV < Parametric
	%Hyperbolic1MagEffectMV  Hyperbolic1MagEffectMV is a subclass of Model for examining the 1-parameter hyperbolic discounting function.

	methods (Access = public)

		function obj = Hyperbolic1MagEffectMV(data, varargin)
			...
			obj.varList.monitored = {'log_lik', 'm', 'c', 'r', 'alpha','epsilon', 'Rpostpred', 'P', 'VA', 'VB'};
            ...
            % obj.varList.discountFunctionParams(3).name = 'r';
			% obj.varList.discountFunctionParams(3).label = '$r$';
