function figParticipantLevelWrapper(mcmc, data, variables, participant_prior_variables, saveFolder, modelType, opts, type, participantFigPlotFunc)
  ...
  function doParticipantPlot()
    ...
    participantFigPlotFunc(mcmc.getSamplesAtIndex(n, variables),...
      mcmc.getParticipantPointEstimates(type, n),...,...
